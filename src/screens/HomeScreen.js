...
import { View, Text, Image, TouchableOpacity, ScrollView, Dimensions, StyleSheet, SafeAreaView } from "react-native";
...
export default function HomeScreen() {
  const [temperature, setTemperature] = useState("22ºC");
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Icon name="menu" size={28} color="#fff" style={{ marginLeft: 10 }} />
